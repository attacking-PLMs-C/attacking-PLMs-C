...
#         # print(inputs_ids_1.shape, inputs_ids_2.shape, '######')
#         # print(position_idx_1.shape, position_idx_2.shape)
#         # print(attn_mask_1.shape, "###", attn_mask_2.shape)
#         # inputs_ids=torch.cat((inputs_ids_1,inputs_ids_2),1)
#         # position_idx=torch.cat((position_idx_1,position_idx_2),1)
...
#         # print(inputs_ids.shape, position_idx.shape)
#         # print("*****************")
...
#             with torch.no_grad():
#                 lm_loss, logit = self.forward(inputs_ids_1,position_idx_1,attn_mask_1,inputs_ids_2,position_idx_2,attn_mask_2,label)
